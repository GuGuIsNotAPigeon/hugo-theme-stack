...
* 打開 `config\_default\hugo.toml`，把`baseURL = "https://guguisnotapigeon.github.io/"`改成`https://你的GitHub使用者名稱.github.io`
...
此時 `public` 資料夾中會出現許多檔案

![public 資料夾](./publicDir.jpg)
